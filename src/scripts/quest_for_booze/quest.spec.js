...
describe('testing quest_for component', function(){
	...
	describe('searchReducer', function(){
		...
		const reducedDate = [{"name":"Hogsback Vintage Lager","image_thumb_url":"https://dx5vpyka4lqst.cloudfront.net/products/289793/images/thumb.png","producer_name":"Hogsback Brewing Company",	"id":289793}];
	...
	describe('updateOutPut', function(){
		...
		it('should return a dom node - implement ENZYME');
	...
	describe('dropDownTemplate', function(){
	...
	describe('renderFactory', function(){
		
		
		it('renderFactory needs to be rewritten - NOTE see if we can implement these through an Observable chain')
